...
In particular, linearity is a crucial assumption in conventional control theory \cite{control-textbook-1,control-textbook-2}, while recent advances in reinforcement learning has come full circle
at applications traditionally considered as ``homegrounds'' for control theory (rather than especially non-reinforcement flavors of machine learning), like robotics \cite{RL-robotics,Li2021ReinforcementLF},
and aeronautics \cite{Wang2022DeepRL}, and even control of active vehicle suspensions \cite{RL-car-suspension}.
