...
Multi-agent reinforcement learning \cite{collective-1993,multiagent-1994-most-cited}, as with other flavors of reinforcement learning, has been enjoying increased attention in artificial intelligence research \cite{unified-multiagent}.
Both further promises and challenges have been discussed, particularly signified by the
...
In fact, multiagent reinforcement learning was first introduced as ``collective learning'' \cite{collective-1993}.
