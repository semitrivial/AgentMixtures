...
\label{omnibusdefn}
    ...
    \begin{enumerate}
        ...
        \item
        An \emph{agent} is defined as a function
        ...
        with domain $(\mathcal E\mathcal A)^*$,
        which assigns to every
        $h\in (\mathcal E\mathcal A)^*$
        a $\mathbb Q$-valued probability measure,
        written $\mu(\cdot|h)$,
        on $\mathcal E$.
        For every such $s$ and every $(o,r)\in\mathcal E$,
        ...
        \begin{enumerate}
            \item $x_1\in \mathcal E$ is chosen randomly based
            on the probability measure $\mu(\cdot|\epsilon)$.
            \item $y_1\in\mathcal A$ is chosen randomly based on the probability
            measure $\pi(\cdot|x_1)$.
            \item
            For each $i>1$,
            $x_i\in\mathcal E$ is chosen randomly based on
...
\label{pullbackdef}
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item
            If $h=g\circ p$ for some $p\in\mathcal E$ then $P^\pi(h)=P^\pi(g)$.
            \item
        ...
        \begin{itemize}
            ...
            \item
            If $h=g\circ p$ for some $p\in\mathcal E$ then $P_\mu(h)=P_\mu(g)\mu(p|g)$.
            \item
        ...
        \begin{itemize}
            ...
            \item
            If $h=g\circ p$ for some $p\in\mathcal E$ then
...
\begin{proof}
    ...
    Case 2: $h=g\circ p$ for some $p\in\mathcal E$.
        Then
        \begin{align*}
            P^\pi_\mu(h)
                &= P^\pi_\mu(g)\mu(p|g)
...
\label{maindefn}
    ...
    $h\in (\mathcal E\mathcal A)^*\mathcal E$, let
    \[
...
\begin{proof}
    ...
    Case 2: $h=g\circ p$ for some $p\in\mathcal E$. Then
    \begin{align*}
...
\begin{proof}
    ...
    Case 2: $h=h_0\circ a_0$ for some
        $h_0\in(\mathcal E\mathcal A)^*\mathcal E$, $a_0\in\mathcal A$.
    ...
    Case 3: $h=h_0\circ p$ for some $h_0\in (\mathcal E\mathcal A)^*$,
        $p\in\mathcal E$.
...
\begin{proof}
    ...
    For any $h\in(\mathcal E\mathcal A)^*\mathcal E$ and $a\in\mathcal A$,
    we claim
...
\begin{proof}
    ...
    Case 2: $g=f\circ p$ for some $p\in\mathcal E$.
    Then
    \begin{align*}
        P^\pi(g)
            &= P^\pi(f)
