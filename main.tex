...
More specifically, we formally examine the expected intelligence of a group of intelligent agents, using an abstract model of universal reinforcement learning agents.
