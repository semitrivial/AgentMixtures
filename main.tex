...
In particular, linearity is a crucial assumption in conventional control theory \cite{control-textbook-1,control-textbook-2}, while recent applications of reinforcement learning have come full circle
at traditional ``homegrounds'' for control theory, like robotics \cite{RL-robotics,Li2021ReinforcementLF},
