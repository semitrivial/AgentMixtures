...
Multi-agent reinforcement learning \cite{collective-1993,multiagent-1994-most-cited,\cite{collective-1993,multiagent-1994-most-cited}}, as with other flavors of reinforcement learning, has been enjoying increased attention in artificial intelligence research \cite{unified-multiagent}.
...
The most straightforward way to conceive multiagent reinforcement learning, is to passively consider the collective behavior of aggregated intelligent agents.
In fact, multiagent reinforcement learning was at first introduced as ``collective learning'' \cite{collective-1993} before ever being explicitly called out as multiagent reinforcement learning \cite{multiagent-1994-most-cited}.
