...
More specifically, we formally examine the expected intelligence of a group of agents, using an abstract universal model of reinforcement learning agents \cite{legg2007universal}.
