...
The most straightforward way to think of multiagent reinforcement learning, is to passively consider the collective behavior of aggregated intelligent agents.
In fact, multiagent reinforcement learning was at first introduced as ``collective learning'' \cite{collective-1993} before being explicitly called out as multiagent reinforcement learning \cite{multiagent-1994-most-cited}.
