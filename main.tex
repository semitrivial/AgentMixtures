...
\begin{proof}
    ...
    We need only show $(\frac12,\frac12)\cdot(\rho,\overline{\rho})$ is a Janus agent,
    i.e., that
    $(\frac12,\frac12)\cdot(\rho,\overline{\rho})
    =\overline{(\frac12,\frac12)\cdot(\rho,\overline{\rho})}$.
    For any $h\in(\mathcal P\mathcal A)^*(\mathcal P)$ and $a\in\mathcal A$,
    we claim
    $\overline{(\frac12,\frac12)\cdot(\rho,\overline{\rho})}(a|h)
    =((\frac12,\frac12)\cdot(\rho,\overline{\rho}))(a|h)$.
    If $(\frac12,\frac12)\cdot(\rho,\overline\rho)_*(h)=0$
    then it follows by Lemmas \ref{doublenegationlemma} and
    \ref{asteriskcommuteswithoverlinelemma} that
    $\overline{(\frac12,\frac12)\cdot(\rho,\overline\rho)}_*(h)=0$,
    so by Definition \ref{maindefn},
    $\overline{(\frac12,\frac12)\cdot(\rho,\overline{\rho})}(a|h)
    =((\frac12,\frac12)\cdot(\rho,\overline{\rho}))(a|h)=1/|\mathcal A|$.
    But assume $(\frac12,\frac12)\cdot(\rho,\overline\rho)_*(h)\not=0$.
    Then:
    \begin{align*}
        \overline{(\mbox{$\frac12$},\mbox{$\frac12$})\cdot(\rho,\overline{\rho})}(a|h)
        &= ((\mbox{$\frac12$},\mbox{$\frac12$})\cdot(\rho,\overline{\rho}))(a|\overline h)
            &\mbox{(Definition \ref{dualagentsdefn})}\\
        &= \frac
            {\frac12\rho_*(\overline h\frown a)+\frac12\overline\rho_*(\overline h\frown a)}
            {\frac12\rho_*(\overline h)+\frac12\overline\rho_*(\overline h)}
            &\mbox{(Definition \ref{maindefn})}\\
        &= \frac
            {\frac12\rho_*(\overline{h\frown a})+\frac12\overline\rho_*(\overline{h\frown a})}
            {\frac12\rho_*(\overline h)+\frac12\overline\rho_*(\overline h)}
        ...
        &= \frac
            {\frac12\overline\rho_*(h\frown a)+\frac12\overline{\overline\rho}_*(h\frown a)}
            {\frac12\overline\rho_*(h)+\frac12\overline{\overline\rho}_*(h)}
            &\mbox{(Lemma \ref{asteriskcommuteswithoverlinelemma})}\\
        &= ((\mbox{$\frac12$},\mbox{$\frac12$})
            \cdot(\overline{\overline\rho},\overline\rho))(a|h)
            &\mbox{(Definition \ref{maindefn})}\\
        &= ((\mbox{$\frac12$},\mbox{$\frac12$})\cdot(\rho,\overline\rho))(a|h).
