...
More specifically, we formally examine the expected intelligence of a group of agents, using a abstract universal model of reinforcement learning agents.
