...
\label{trivialinductionlemma}
    ...
    \begin{enumerate}
        ...
        \item If $h=gx$ for some $x\in\mathcal A$, if $\mathscr P(g)$, then $\mathscr P(h)$.
        \item If $h=gy$ for some $y\in\mathcal E$, if $\mathscr P(g)$, then $\mathscr P(h)$.
    \end{enumerate}
...
\begin{proof}
    ...
    $h=gx$ for some $x\in\mathcal A$ such that $g$ has length $\ell-1$.
    By induction, $\mathscr P(g)$. Thus $\mathscr P(h)$ by (2).
    Otherwise, $h\in(\mathcal E\mathcal A)^*\mathcal A$, which implies
    $h=gy$ for some $y\in\mathcal E$ such that $g$ has length $\ell-1$.
