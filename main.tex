...
In this work, we draw inspiration from sortition, yet another way of social organization with an ancient root \cite{sortition-ancient} in the history cal Athenian democracy.
