...
\begin{abstract}
    In this work, we investigate the crowd intelligence and collective behaviour
    of theoretical intelligent agents by
    introducing a weighted linear mixture operation on universal
    reinforcement learning agents. The weighted linear mixture of multiple agents leads to the
