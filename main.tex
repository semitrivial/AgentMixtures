...
the universal intelligent agent model by effectively letting the agent to, in a sense, look at the future, by playing the same game several times during a separate ``training'' phase.
On the other hand, if we consider a life of a human being as a game played by a reinforcement learning agent,
the game is certainly non-ergodic and can only played once by an agent.
