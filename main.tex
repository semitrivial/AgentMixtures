...
\begin{abstract}
    ...
    in this work we investigate the collective intelligent behaviour
    of theoretical universal agents by
    examining a weighted linear mixture operation on them.
    The weighted linear mixture of multiple agents leads to the
