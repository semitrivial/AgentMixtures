...
It is worth noting that "collaborative" reinforcement learning sometimes refers to collaboration between human users and artificial agents, rather than that between artificial agent \cite{collab-other}.
