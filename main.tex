...
In this work, we draw inspiration from sortition, yet another way of social organization, which itself has attracted theoretical curiocity \cite{nature-sortition}
