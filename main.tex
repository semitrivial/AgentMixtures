...
\begin{proof}
    Define $f:[0,1]\to\mathbb R$ by $f(\alpha)=\alpha A+(1-\alpha)C$.
    Clearly $f$ is continuous, $f(0)=C$, and $f(1)=A$.
    By the intermediate value theorem, some $\alpha$ exists with $f(\alpha)=B$.
\end{proof}
...
\begin{proof}
    ...
    such that $i_1\in I$ and $i_2\in I$.
