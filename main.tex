...
In particular, linearity is a crucial assumption in conventional control theory \cite{control-textbook-1,control-textbook-2}. With its early history involving optimal control \cite{Sutton2005ReinforcementLA-mentions-optimal-control}, a branch of control theory, recently reinforcement learning has come full circle at being increasely applied to
...
comparable to Nyquist stability in control theory, may become very used for
